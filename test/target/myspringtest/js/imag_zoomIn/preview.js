...
this.imagePreview=function(d,c){
	...
	$(c).hover(function(e){
		$("body").append("<div id='preview' class='previewShowWindow'><img id='pi' src='/upload/cloth_imag/loadingAnimation.gif' alt='Now Loading' /></div>");
		...
		if((e.pageX+offX+o)>a){
			...
			$("#preview").css("top",50).css("left",100).fadeIn("fast");
		},function(){
			$("#preview").remove();
	});
